...
@Autonomous(name = "Blue Auto: Gear Wizards Edition", group = "$", preselectTeleOp = "TeleOp")
public class BlueAutoGearWizards extends NextFTCOpMode {
    private Paths paths;
    private boolean aborted = false;

    public BlueAutoGearWizards() {
        addComponents(
